...
handling.  Unicode paste is mostly coded except for auto-newline.
...
void PtermFrame::OnPasteTimer (wxTimerEvent &)
{
    ...
    else
    {
        ...
        // Send what we found.  Note that we don't have to special case
        // a no-match, because ptermSendKey will send all the codes that 
        // are not None and no-match is simply None.
        ptermSendKey (p);
    }
