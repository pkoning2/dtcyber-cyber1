...
bool PtermApp::DoConnect (bool ask)
{
    ...
    if (ask)
    {
        PtermConnDialog dlg (wxID_ANY, _("Connect to PLATO"), wxDefaultPosition, wxSize( 415,174 ));
...
void PtermApp::OnPref (wxCommandEvent&)
{
    ...
    PtermPrefDialog dlg (NULL, wxID_ANY, _("Pterm Preferences"), wxDefaultPosition, wxSize( 450,358 ) );
...
//	wxButton* btnDefaults;
	...
	lblExplain1 = new wxStaticText( tab1, wxID_ANY, wxT(_("Settings on this page let you fine-tune your PLATO experience.")), wxDefaultPosition, wxDefaultSize, 0 );
	page1->Add( lblExplain1, 0, wxALL, 5 );
	chkSimulate1200Baud = new wxCheckBox( tab1, wxID_ANY, wxT(_("Simulate 1200 baud")), wxDefaultPosition, wxDefaultSize, 0 );
	page1->Add( chkSimulate1200Baud, 0, wxALL, 5 );
	chkEnableGSW = new wxCheckBox( tab1, wxID_ANY, wxT(_("Enable GSW (not in ASCII)")), wxDefaultPosition, wxDefaultSize, 0 );
	chkEnableGSW->SetValue(true);
	page1->Add( chkEnableGSW, 0, wxALL, 5 );
	chkEnableNumericKeyPad = new wxCheckBox( tab1, wxID_ANY, wxT(_("Enable numeric keypad for arrow operation")), wxDefaultPosition, wxDefaultSize, 0 );
	chkEnableNumericKeyPad->SetValue(true);
	page1->Add( chkEnableNumericKeyPad, 0, wxALL, 5 );
	chkUsePLATOKeyboard = new wxCheckBox( tab1, wxID_ANY, wxT(_("Use real PLATO keyboard")), wxDefaultPosition, wxDefaultSize, 0 );
	page1->Add( chkUsePLATOKeyboard, 0, wxALL, 5 );
	chkEnableBeep = new wxCheckBox( tab1, wxID_ANY, wxT(_("Enable -beep-")), wxDefaultPosition, wxDefaultSize, 0 );
	chkEnableBeep->SetValue(true);
	page1->Add( chkEnableBeep, 0, wxALL, 5 );
	tab1->SetSizer( page1 );
	tab1->Layout();
	page1->Fit( tab1 );
	tabPrefsDialog->AddPage( tab1, wxT(_("Emulation")), true );
	//tab2
	...
	lblExplain2 = new wxStaticText( tab2, wxID_ANY, wxT(_("Settings on this page specify where PLATO is on the internet.")), wxDefaultPosition, wxDefaultSize, 0 );
	page2->Add( lblExplain2, 1, wxALL|wxEXPAND, 5 );
	wxBoxSizer* bs21;
	bs21 = new wxBoxSizer( wxVERTICAL );
	chkConnectAtStartup = new wxCheckBox( tab2, wxID_ANY, wxT(_("Connect at startup")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblDefaultHost = new wxStaticText( tab2, wxID_ANY, wxT(_("Default Host")), wxDefaultPosition, wxDefaultSize, 0 );
	fgs211->Add( lblDefaultHost, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	txtDefaultHost = new wxTextCtrl( tab2, wxID_ANY, wxT("cyberserv.org"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	...
	lblDefaultPort = new wxStaticText( tab2, wxID_ANY, wxT(_("Default Port*")), wxDefaultPosition, wxDefaultSize, 0 );
	fgs211->Add( lblDefaultPort, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	cboDefaultPort = new wxComboBox( tab2, wxID_ANY, wxT("5004"), wxDefaultPosition, wxSize( 75,-1 ), 0, NULL, 0 );
	...
	lblExplainPort = new wxStaticText( tab2, wxID_ANY, wxT(_("* NOTE: 5004=Classic, 8005=ASCII (with -color- available)")), wxDefaultPosition, wxDefaultSize, 0 );
	page2->Add( lblExplainPort, 0, wxALL, 5 );
	tab2->SetSizer( page2 );
	tab2->Layout();
	page2->Fit( tab2 );
	tabPrefsDialog->AddPage( tab2, wxT(_("Connection")), false );
	//tab3
	...
	lblExplain3 = new wxStaticText( tab3, wxID_ANY, wxT(_("Settings on this page allow you to change the display appearance.")), wxDefaultPosition, wxDefaultSize, 0 );
	page3->Add( lblExplain3, 0, wxALL, 5 );
	wxBoxSizer* bs31;
	bs31 = new wxBoxSizer( wxVERTICAL );
	chkZoom200 = new wxCheckBox( tab3, wxID_ANY, wxT(_("Zoom display 200%")), wxDefaultPosition, wxDefaultSize, 0 );
	bs31->Add( chkZoom200, 0, wxALL, 5 );
	chkStatusBar = new wxCheckBox( tab3, wxID_ANY, wxT(_("Display status bar")), wxDefaultPosition, wxDefaultSize, 0 );
	chkStatusBar->SetValue(true);
	bs31->Add( chkStatusBar, 0, wxALL, 5 );
	chkDisableColor = new wxCheckBox( tab3, wxID_ANY, wxT(_("Disable -color- (ASCII mode)")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblFGColor = new wxStaticText( tab3, wxID_ANY, wxT(_("Foreground color*")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblBGColor = new wxStaticText( tab3, wxID_ANY, wxT(_("Background color*")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblExplainColor = new wxStaticText( tab3, wxID_ANY, wxT(_("* NOTE: Applied in Classic mode or if -color- is disabled in ASCII mode")), wxDefaultPosition, wxDefaultSize, 0 );
	page3->Add( lblExplainColor, 0, wxALL, 5 );
	tab3->SetSizer( page3 );
	tab3->Layout();
	page3->Fit( tab3 );
	tabPrefsDialog->AddPage( tab3, wxT(_("Display")), false );
	//tab4
	...
	lblExplain4 = new wxStaticText( tab4, wxID_ANY, wxT(_("Settings on this page allow you to specify Paste options.")), wxDefaultPosition, wxDefaultSize, 0 );
	bs41->Add( lblExplain4, 0, wxALL, 5 );
	wxFlexGridSizer* fgs411;
	fgs411 = new wxFlexGridSizer( 2, 3, 0, 0 );
	lblCharDelay = new wxStaticText( tab4, wxID_ANY, wxT(_("Delay between chars")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblCharDelay2 = new wxStaticText( tab4, wxID_ANY, wxT(_("milliseconds")), wxDefaultPosition, wxDefaultSize, 0 );
	fgs411->Add( lblCharDelay2, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	lblLineDelay = new wxStaticText( tab4, wxID_ANY, wxT(_("Delay after end of line")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblLineDelay2 = new wxStaticText( tab4, wxID_ANY, wxT(_("milliseconds")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblAutoNewLine = new wxStaticText( tab4, wxID_ANY, wxT(_("Automatic new line every")), wxDefaultPosition, wxDefaultSize, 0 );
	fgs4111->Add( lblAutoNewLine, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	cboAutoLF = new wxComboBox( tab4, wxID_ANY, wxT("60"), wxDefaultPosition, wxSize( -1,-1 ), 0, NULL, 0|wxTAB_TRAVERSAL );
	...
	lblAutoNewLine2 = new wxStaticText( tab4, wxID_ANY, wxT(_("characters")), wxDefaultPosition, wxDefaultSize, 0 );
	fgs4111->Add( lblAutoNewLine2, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	bs41->Add( fgs4111, 0, wxEXPAND, 5 );
	chkConvertDot7 = new wxCheckBox( tab4, wxID_ANY, wxT(_("Convert periods followed by 7 spaces into period/tab*")), wxDefaultPosition, wxDefaultSize, 0 );
	chkConvertDot7->SetValue(true);
	chkConvertDot7->Hide();
	bs41->Add( chkConvertDot7, 0, wxALL, 5 );
	chkConvert8Spaces = new wxCheckBox( tab4, wxID_ANY, wxT(_("Convert 8 consecutive spaces into a tab*")), wxDefaultPosition, wxDefaultSize, 0 );
	chkConvert8Spaces->SetValue(true);
	chkConvert8Spaces->Hide();
	bs41->Add( chkConvert8Spaces, 0, wxALL, 5 );
	page4->Add( bs41, 1, wxEXPAND, 5 );
	lblExplainConversions = new wxStaticText( tab4, wxID_ANY, wxT(_("* NOTE: Conversions are applied at 8-character intervals.")), wxDefaultPosition, wxDefaultSize, 0 );
	lblExplainConversions->Hide();
	page4->Add( lblExplainConversions, 0, wxALL|wxALIGN_BOTTOM, 5 );
	tab4->SetSizer( page4 );
	tab4->Layout();
	page4->Fit( tab4 );
	tabPrefsDialog->AddPage( tab4, wxT(_("Pasting")), false );
	//tab5
	...
	lblExplain5 = new wxStaticText( tab5, wxID_ANY, wxT(_("Settings on this page allow you to control local processing.")), wxDefaultPosition, wxDefaultSize, 0 );
	page5->Add( lblExplain5, 0, wxALL, 5 );
	chkAllowPPT = new wxCheckBox( tab5, wxID_ANY, wxT(_("Allow PPT programs to load and execute")), wxDefaultPosition, wxDefaultSize, 0 );
	chkAllowPPT->Enable( false );
	page5->Add( chkAllowPPT, 0, wxALL, 5 );
	chkAllowMicroTutor = new wxCheckBox( tab5, wxID_ANY, wxT(_("Allow \xB5TUTOR programs to load and execute")), wxDefaultPosition, wxDefaultSize, 0 );
	chkAllowMicroTutor->Enable( false );
	page5->Add( chkAllowMicroTutor, 0, wxALL, 5 );
	chkAllowKermit = new wxCheckBox( tab5, wxID_ANY, wxT(_("Enable Kermit data transfer protocol")), wxDefaultPosition, wxDefaultSize, 0 );
	chkAllowKermit->Enable( false );
	page5->Add( chkAllowKermit, 0, wxALL, 5 );
	lblBrowser = new wxStaticText( tab5, wxID_ANY, wxT(_("Specify browser to use for menu option 'Execute URL'")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	tab5->Layout();
	page5->Fit( tab5 );
	tabPrefsDialog->AddPage( tab5, wxT(_("Local")), false );
	...
	btnOK = new wxButton( this, wxID_ANY, wxT(_("OK")), wxDefaultPosition, wxDefaultSize, 0 );
	fgsButtons->Add( btnOK, 0, wxALL, 5 );
	btnCancel = new wxButton( this, wxID_ANY, wxT(_("Cancel")), wxDefaultPosition, wxDefaultSize, 0 );
	fgsButtons->Add( btnCancel, 0, wxALL, 5 );
	btnDefaults = new wxButton( this, wxID_ANY, wxT(_("Defaults")), wxDefaultPosition, wxDefaultSize, 0 );
...
//	wxButton* btnConnect;
	...
	lblHost = new wxStaticText( this, wxID_ANY, wxT(_("Host name")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblPort = new wxStaticText( this, wxID_ANY, wxT(_("Port*")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	lblExplainPort = new wxStaticText( this, wxID_ANY, wxT(_("* NOTE: 5004=Classic, 8005=ASCII (with -color- available)")), wxDefaultPosition, wxDefaultSize, 0 );
	...
	btnQuickConnectClassic = new wxButton( this, wxID_ANY, wxT(_("Quick Connect 'Classic'")), wxDefaultPosition, wxDefaultSize, 0|wxTAB_TRAVERSAL );
	btnQuickConnectClassic->SetFont( wxFont( 10, 74, 90, 90, false, wxT("Arial") ) );
	fgs12->Add( btnQuickConnectClassic, 0, wxALL, 5 );
	btnQuickConnectASCII = new wxButton( this, wxID_ANY, wxT(_("Quick Connect ASCII")), wxDefaultPosition, wxDefaultSize, 0|wxTAB_TRAVERSAL );
	btnQuickConnectASCII->SetFont( wxFont( 10, 74, 90, 90, false, wxT("Arial") ) );
	fgs12->Add( btnQuickConnectASCII, 0, wxALL, 5 );
	btnConnect = new wxButton( this, wxID_ANY, wxT(_("Connect")), wxDefaultPosition, wxDefaultSize, 0|wxTAB_TRAVERSAL );
